...
void initialize()
{
 ...
 (*(volatile unsigned short *)0x4000008) = (0 << 7) | (0 << 14) | ((1) << 2) | ((29) << 8);


 DMANow(3, titleTiles, &((charblock *)0x6000000)[1], 4352 / 2);


 DMANow(3, titleMap, &((screenblock *)0x6000000)[29], 2048 / 2);
...
void goToPause() {
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8);
 DMANow(3, pauseTiles, &((charblock *)0x6000000)[1], 2208 / 2);
...
void goToWin() {
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8);
 DMANow(3, winTiles, &((charblock *)0x6000000)[1], 3264 / 2);
...
void goToLose() {
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8);
 DMANow(3, loseTiles, &((charblock *)0x6000000)[1], 2016 / 2);
